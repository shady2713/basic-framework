...
<template>
  <Teleport defer :to="appendTo">
    ...
    <DialogContent
      ...
      :class="
        cn(
          'z-popup data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 w-full bg-background p-6 shadow-lg outline-none sm:rounded-xl',
          {
