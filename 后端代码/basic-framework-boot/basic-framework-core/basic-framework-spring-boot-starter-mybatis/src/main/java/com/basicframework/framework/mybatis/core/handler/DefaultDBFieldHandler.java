...
public class DefaultDBFieldHandler implements MetaObjectHandler {
    ...
    /**
     * 当前登录用户身份接缝；security starter 缺席（无实现 Bean）时，
     * creator/updater 不做自动填充
     */
    private final ObjectProvider<CurrentUserProvider> currentUserProvider;

    public DefaultDBFieldHandler(ObjectProvider<CurrentUserProvider> currentUserProvider) {
    ...
    private Long getLoginUserId() {
        ...
        return provider != null ? provider.getLoginUserId() : null;
    }
}
