...
import com.basicframework.framework.common.enums.DateIntervalEnum;
        ...
        switch (intervalEnum) {
            case HOUR:
                while (startTime.isBefore(endTime)) {
                    timeRanges.add(new LocalDateTime[] {
                        startTime, startTime.plusHours(1).minusNanos(1)
                    });
            ...
            case DAY:
                while (startTime.isBefore(endTime)) {
                    timeRanges.add(new LocalDateTime[] {
                        startTime, startTime.plusDays(1).minusNanos(1)
                    });
            ...
            case MONTH:
                while (startTime.isBefore(endTime)) {
                    LocalDateTime endOfMonth = startTime
            ...
            case YEAR:
                while (startTime.isBefore(endTime)) {
                    LocalDateTime endOfYear = startTime
                            .with(TemporalAdjusters.lastDayOfYear())
                            .plusDays(1)
                            .minusNanos(1);
