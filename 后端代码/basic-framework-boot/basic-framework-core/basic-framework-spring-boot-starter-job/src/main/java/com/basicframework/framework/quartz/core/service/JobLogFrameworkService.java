package com.basicframework.framework.quartz.core.service;
...
public interface JobLogFrameworkService {
     ...
     */
    Long createJobLog(
            @NotNull(message = "任务编号不能为空") Long jobId,
     ...
     * @param result   成功数据
     */
    void updateJobLogResultAsync(
            @NotNull(message = "日志编号不能为空") Long logId,
