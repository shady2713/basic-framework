package com.basicframework.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
    ...
    /**
     * 异常类型（不记录异常消息，避免持久化潜在敏感值）
     */
    private String exceptionMessage;
    /**
     * 根异常类型（不记录根异常消息，避免持久化潜在敏感值）
     */
     ...
     * 处理用户编号
     *
     * 关联 com.basicframework.module.system.dal.dataobject.user.AdminUserDO
     */
