...
public class FileController {
    ...
    public CommonResult<String> uploadFile(@Valid FileUploadReqVO uploadReqVO) throws Exception {
        ...
        return success(fileService.createFile(
                content, file.getOriginalFilename(), uploadReqVO.getDirectory(), file.getContentType()));
    }
    ...
    public CommonResult<FilePresignedUrlRespVO> getFilePresignedUrl(
            @RequestParam("name") String name, @RequestParam(value = "directory", required = false) String directory) {
        FilePresignedUrlDTO presignedUrl = fileService.presignPutUrl(name, directory);
        return success(new FilePresignedUrlRespVO(
                presignedUrl.getConfigId(),
    ...
    public CommonResult<Long> createFile(@Valid @RequestBody FileCreateReqVO createReqVO) {
        return success(fileService.createFile(BeanUtils.toBean(createReqVO, FileDO.class)));
    }
    ...
    public void getFileContent(
            HttpServletRequest request, HttpServletResponse response, @PathVariable("configId") Long configId)
            throws Exception {
        // 获取请求的路径
