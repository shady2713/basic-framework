...
@Schema(description = "管理后台 - 代码生成表定义修改 Request VO")
@Data
public class CodegenTableSaveReqVO {
    ...
    @Schema(description = "表描述", requiredMode = Schema.RequiredMode.REQUIRED, example = "用户表")
    ...
    @Schema(description = "作者", requiredMode = Schema.RequiredMode.REQUIRED, example = "shady")
    @NotNull(message = "作者不能为空")
    private String author;

    @Schema(
            description = "模板类型，参见 CodegenTemplateTypeEnum 枚举",
    ...
    @Schema(
            description = "前端类型，参见 CodegenFrontTypeEnum 枚举",
            requiredMode = Schema.RequiredMode.REQUIRED,
            example = "50")
    ...
    public boolean isSubValid() {
        return ObjectUtil.notEqual(getTemplateType(), CodegenTemplateTypeEnum.SUB.getType())
    ...
    public boolean isTreeValid() {
        return !CodegenTemplateTypeEnum.isTree(templateType)
