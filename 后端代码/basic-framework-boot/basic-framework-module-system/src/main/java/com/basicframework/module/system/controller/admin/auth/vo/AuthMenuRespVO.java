...
public class AuthMenuRespVO {
    ...
    @Schema(description = "路由地址，仅菜单类型为菜单或者目录时，才需要传", example = "system")
    private String path;

    @Schema(description = "组件路径，仅菜单类型为菜单时，才需要传", example = "system/user/index")
    private String component;

    @Schema(description = "组件名", example = "SystemUser")
    private String componentName;

    @Schema(description = "菜单图标，仅菜单类型为菜单或者目录时，才需要传", example = "ep:menu")
    private String icon;
