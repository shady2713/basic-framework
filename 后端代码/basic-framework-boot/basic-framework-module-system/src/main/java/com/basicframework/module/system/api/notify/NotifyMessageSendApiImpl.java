package com.basicframework.module.system.api.notify;

import com.basicframework.module.system.api.notify.dto.NotifySendSingleToUserReqDTO;
...
public class NotifyMessageSendApiImpl implements NotifyMessageSendApi {
    ...
    public Long sendSingleMessageToAdmin(NotifySendSingleToUserReqDTO reqDTO) {
        return notifySendService.sendSingleNotifyToAdmin(
    ...
    public Long sendSingleMessageToMember(NotifySendSingleToUserReqDTO reqDTO) {
        return notifySendService.sendSingleNotifyToMember(
                reqDTO.getUserId(), reqDTO.getTemplateCode(), reqDTO.getTemplateParams());
    }
}
