...
public class NotifyMessageController {
    ...
    public CommonResult<PageResult<NotifyMessageRespVO>> getNotifyMessagePage(@Valid NotifyMessagePageReqVO pageVO) {
        PageResult<NotifyMessageDO> pageResult = notifyMessageService.getNotifyMessagePage(
                pageVO,
                new NotifyMessageQuery(
                        pageVO.getUserId(),
                        pageVO.getUserType(),
                        pageVO.getTemplateCode(),
                        pageVO.getTemplateType(),
    ...
    public CommonResult<List<NotifyMessageRespVO>> getUnreadNotifyMessageList(
        ...
        List<NotifyMessageDO> list =
                notifyMessageService.getUnreadNotifyMessageList(getLoginUserId(), UserTypeEnum.ADMIN.getValue(), size);
