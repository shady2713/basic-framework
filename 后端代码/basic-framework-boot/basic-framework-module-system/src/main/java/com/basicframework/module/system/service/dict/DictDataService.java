...
public interface DictDataService {
     ...
     * @return 字典数据编号
     */
    Long createDictData(DictDataDO dictData);

    /**
     * 更新字典数据
     *
     * @param updateObj 字典数据信息
     */
    void updateDictData(DictDataDO updateObj);
     ...
     * @param label     字典标签，模糊匹配
     * @param dictType  字典类型
     * @param status    展示状态
     * @return 字典数据分页列表
     */
    PageResult<DictDataDO> getDictDataPage(PageParam pageParam, String label, String dictType, Integer status);
