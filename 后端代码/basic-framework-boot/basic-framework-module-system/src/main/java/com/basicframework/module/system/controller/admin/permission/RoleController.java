...
public class RoleController {
    ...
    public CommonResult<Long> createRole(@Valid @RequestBody RoleSaveReqVO createReqVO) {
        return success(roleService.createRole(BeanUtils.toBean(createReqVO, RoleDO.class), null));
    }
    ...
    public CommonResult<Boolean> updateRole(@Valid @RequestBody RoleSaveReqVO updateReqVO) {
        roleService.updateRole(BeanUtils.toBean(updateReqVO, RoleDO.class));
        return success(true);
    }
